...
function setNeighbours(A) {
    for (let i = 0; i < 10; i++) {
        for (let j = 0; j < 10; j++) {
            ...
            if (i < 9 && j > 0 && A[i + 1][j - 1] === 'B') {
                count++;
            }
            if (i < 9 && A[i + 1][j] === 'B') {
                count++;
            }
            if (i < 9 && j < 9 && A[i + 1][j + 1] === 'B') {
                count++;
            }
        ...
        for (let j = 0; j < 10; j++) {
            if (B[i][j] === 1) {
                if (A[i][j] == '0') {
                    ...
                    if (i < 9 && j > 0 && B[i + 1][j - 1] === 0) {
                        B[i + 1][j - 1] = 1;
                    }
                    if (i < 9 && B[i + 1][j] === 0) {
                        B[i + 1][j] = 1;
                    }
                    if (i < 9 && j < 9 && B[i + 1][j + 1] === 0) {
                        B[i + 1][j + 1] = 1;
                    }
                }
            }
            ...
            for (let j = 0; j < 10; j++) {
                ...
                if (B[i][j] === 1) {
                    if (A[i][j] == 'B') {
                        ...
                        context.fillText(A[i][j], i * 40 + 10, j * 40 + 30);
                        if (gameStatus == 1) {
                            gameOver(context);
                        }
                    } else {
